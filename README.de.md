...
- Teste Töne direkt im Einstellungs-Panel und stelle ihre Lautstärke unabhängig vom Twitch-Player ein.
...
| Benachrichtigungen | Ton | Wählt und testet einen der 18 Benachrichtigungstöne. |
| Benachrichtigungen | Lautstärke | Regelt den Benachrichtigungston unabhängig vom Twitch-Player. |
...
- Bei aktivierten Avataren werden geprüfte Twitch-Login-Namen aus Chat und Dashboard-Rangliste gebündelt an Twitchs GraphQL-Endpunkt gesendet.
